<template>
  ...
  >
    <!-- Add this block  -->
    <template #normal-header-title="{ title }">
      <v-alert type="success">Custom normal: {{ title }}</v-alert>
    </template>
    <!-- End  -->
    ...
    <!-- Add this block  -->
    <template #trash-header-title="{ title }">
      <v-alert type="success">Custom trash: {{ title }}</v-alert>
    </template>
    <!-- End  -->
